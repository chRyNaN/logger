 ...
 * assigned to the [loggable] property, this defaults to the [DefaultLogger]. Optionally, the [init] function can be
 * called next, which just delegates to the [loggable] init function if it is a [LogInitializer] implementation.
 *
...
object Log : Loggable,
    ...
    var loggable: Loggable = DefaultLogger()
